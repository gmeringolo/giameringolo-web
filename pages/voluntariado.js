          ...
          <div className="card lg:w-1/3 lg:mr-3">
            <div className="card__content text-center transition-transform duration-1000">
              <div className="card__front">
                ...
                />
                <div className="absolute top-[87%] left-1/2 -translate-x-1/2 -translate-y-1/2 bg-purple text-pale font-inter_tight text-base mb-1  w-full rounded-3xl p-2"><strong>Rescatista de gatos Grupo Iot</strong><br />May 2010 - Presente</div>
              </div>
            ...
            <div className="card__content text-center transition-transform duration-1000">
              <div className="card__front">
                <Image
                  ...
                  className="rounded-3xl"
                />
                <div className="absolute top-[87%] left-1/2 -translate-x-1/2 -translate-y-1/2 bg-purple text-pale font-inter_tight text-base mb-1  w-full rounded-3xl p-2"><strong>Colaboradora MujeresIT</strong><br />Feb 2021 - Presente</div>
              </div>
              <div className="card__back absolute top-0 bottom-0 right-0 left-0 p-8 bg-primary text-white flex flex-col items-center justify-center shadow-xl rounded-3xl">
            ...
            <div className="card__content text-center transition-transform duration-1000">
              <div className="card__front">
                <Image
                  ...
                  className="rounded-3xl"
                />
                <div className="absolute top-[87%] left-1/2 -translate-x-1/2 -translate-y-1/2 bg-purple text-pale font-inter_tight text-base mb-1  w-full rounded-3xl p-2"><strong>Colaboratora - RSG (Globant)</strong><br />Jan 2022 - Abr 2024</div>
              </div>
              <div className="card__back absolute top-0 bottom-0 right-0 left-0 p-8 bg-primary text-white flex flex-col items-center justify-center shadow-xl rounded-3xl">
